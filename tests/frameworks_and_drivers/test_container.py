...
def test_container_initialization(mock_settings, mock_get_engine):
...
def test_container_properties(mock_settings, mock_get_engine):
...
def test_container_wires_dependencies_correctly(mock_settings, mock_get_engine):
...
def test_container_retention_policy_from_settings(mock_settings, mock_get_engine):
