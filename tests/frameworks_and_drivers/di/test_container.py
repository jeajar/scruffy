...
def mock_settings():
    ...
    with patch(
        ...
        with patch(
            ...
            mock.seerr_url = "http://test.com"
            mock.seerr_api_key = "test-key"
...
class TestContainerInitialization:
    ...
    def test_container_initialization(self, mock_settings, mock_get_engine):
        ...
        assert container._seerr_gateway is not None
...
class TestContainerProperties:
    ...
    def test_container_properties(self, mock_settings, mock_get_engine):
        ...
        assert container.seerr_gateway == container._seerr_gateway
...
class TestContainerDependencyWiring:
    ...
    def test_container_wires_dependencies_correctly(
        ...
        assert container._seerr_gateway.http_client == container._http_client
        ...
        assert container._check_use_case.request_repository == container._seerr_gateway
